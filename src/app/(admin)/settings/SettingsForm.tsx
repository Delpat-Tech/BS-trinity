  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-[24px]">
        ...
        <div className="p-[20px] flex flex-col gap-[16px]">
          <div className="grid grid-cols-2 gap-[24px]">
            <div className="flex flex-col gap-[6px]">
              ...
              <input id="shift_start" name="shift_start" type="time" defaultValue={initialData.shift_start} className="w-full rounded-[4px] border border-border-strong px-[10px] py-[8px] font-mono text-[13px] outline-none focus:border-[#E8630A]" />
            </div>
            <div className="flex flex-col gap-[6px]">
              <label htmlFor="shift_end" className="text-[12px] font-medium text-text-secondary">Shift End</label>
              <input id="shift_end" name="shift_end" type="time" defaultValue={initialData.shift_end} className="w-full rounded-[4px] border border-border-strong px-[10px] py-[8px] font-mono text-[13px] outline-none focus:border-[#E8630A]" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-[24px]">
            <div className="flex flex-col gap-[6px]">
              ...
              <input id="half_day_if_in_after" name="half_day_if_in_after" type="time" defaultValue={initialData.half_day_if_in_after} className="w-full rounded-[4px] border border-border-strong px-[10px] py-[8px] font-mono text-[13px] outline-none focus:border-[#E8630A]" />
            </div>
            <div className="flex flex-col gap-[6px]">
              <label htmlFor="half_day_if_out_before" className="text-[12px] font-medium text-text-secondary">Half-day if OUT before</label>
              <input id="half_day_if_out_before" name="half_day_if_out_before" type="time" defaultValue={initialData.half_day_if_out_before} className="w-full rounded-[4px] border border-border-strong px-[10px] py-[8px] font-mono text-[13px] outline-none focus:border-[#E8630A]" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-surface border border-border shadow-[0_1px_2px_rgba(0,0,0,0.02)] rounded-[4px] overflow-hidden">
        ...
        <div className="p-[20px] flex flex-col gap-[16px]">
          <div className="flex flex-col gap-[6px]">
            ...
            <input id="grace_until" name="grace_until" type="time" defaultValue={initialData.grace_until} className="w-[200px] rounded-[4px] border border-border-strong px-[10px] py-[8px] font-mono text-[13px] outline-none focus:border-[#E8630A]" />
          ...
          <div className="grid grid-cols-2 gap-[24px]">
            <div className="flex flex-col gap-[16px]">
              ...
              <div className="flex items-center gap-[12px]">
                <input id="late_strike_start" name="late_strike_start" type="time" defaultValue={initialData.late_strike_window[0]} className="flex-1 rounded-[4px] border border-border-strong px-[10px] py-[8px] font-mono text-[13px] outline-none focus:border-[#E8630A]" />
                <span className="text-text-secondary">to</span>
                <input id="late_strike_end" name="late_strike_end" type="time" defaultValue={initialData.late_strike_window[1]} className="flex-1 rounded-[4px] border border-border-strong px-[10px] py-[8px] font-mono text-[13px] outline-none focus:border-[#E8630A]" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-[16px]">
              ...
              <div className="flex items-center gap-[12px]">
                <input id="early_strike_start" name="early_strike_start" type="time" defaultValue={initialData.early_strike_window[0]} className="flex-1 rounded-[4px] border border-border-strong px-[10px] py-[8px] font-mono text-[13px] outline-none focus:border-[#E8630A]" />
                <span className="text-text-secondary">to</span>
                <input id="early_strike_end" name="early_strike_end" type="time" defaultValue={initialData.early_strike_window[1]} className="flex-1 rounded-[4px] border border-border-strong px-[10px] py-[8px] font-mono text-[13px] outline-none focus:border-[#E8630A]" />
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-[24px]">
            <div className="flex flex-col gap-[6px]">
              ...
              <input id="strikes_per_penalty" name="strikes_per_penalty" type="number" defaultValue={initialData.strikes_per_penalty} className="w-full rounded-[4px] border border-border-strong px-[10px] py-[8px] font-mono text-[13px] outline-none focus:border-[#E8630A]" />
            </div>
            <div className="flex flex-col gap-[6px]">
              <label htmlFor="penalty_days_per_trigger" className="text-[12px] font-medium text-text-secondary">Penalty Days Deduction</label>
              <input id="penalty_days_per_trigger" name="penalty_days_per_trigger" type="number" step="0.5" defaultValue={initialData.penalty_days_per_trigger} className="w-full rounded-[4px] border border-border-strong px-[10px] py-[8px] font-mono text-[13px] outline-none focus:border-[#E8630A]" />
        ...
        <div className="p-[20px] flex flex-col gap-[16px]">
          ...
          <label className="flex items-start gap-[10px] cursor-pointer">
            <input 
              ...
              className="mt-[3px] w-[14px] h-[14px] accent-[#E8630A]" 
            />
            <div>
      ...
      <div className="flex justify-start pb-[40px]">
        <button type="submit" disabled={loading} className="px-[16px] py-[8px] border border-text bg-[#E8630A] text-white rounded-[6px] text-[13px] font-medium hover:bg-[#C9540A] disabled:opacity-50">
